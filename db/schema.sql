...
ALTER TABLE hasil_test ADD COLUMN IF NOT EXISTS nama VARCHAR(100);
ALTER TABLE hasil_test ADD COLUMN IF NOT EXISTS umur INT;
ALTER TABLE hasil_test ADD COLUMN IF NOT EXISTS alamat TEXT;
