...
export async function GET(req) {
  ...
  const baris = [
    'id,kandidat,username,tipe,kategori,level,benar,total,skor,tanggal',
    ...daftar.map((h) => [
      h.id, esc(h.nama_user || h.username), esc(h.username), h.tipe, esc(h.kategori),
      h.level, h.benar, h.total_soal, h.skor,
